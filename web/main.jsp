...
<div class="container marketing">
    <div class="row">
      ...
      <div class="col-lg-4" style="text-align: center">
        ...
        <p><a class="btn btn-secondary" data-bs-toggle="collapse" href="#친구야이건알지" role="button" aria-expanded="false" aria-controls="collapseExample">자세히 보기 &raquo;</a></p>
        	<div class="collapse" id="친구야이건알지">
        		<div class="d-grid gap-2 col-6 mx-auto">
				<a class="btn btn-secondary" href="" role="button">페이지 설명 및 사용법</a>
				<a class="btn btn-secondary" href="" role="button">부품 설명</a>
				</div>
			</div>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4" style="text-align: center">
